    ...
    return (    
        <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden bg-gradient-to-br from-zinc-50 via-zinc-100 to-zinc-200 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-800">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                <div className="absolute -top-12 -right-12 w-72 h-72 rounded-full border border-primary/10" />
                <div className="absolute -bottom-32 -left-32 w-[500px] h-[500px] rounded-full border border-zinc-300/30 dark:border-zinc-700/30" />
                <div className="absolute -bottom-16 -left-16 w-80 h-80 rounded-full border border-zinc-300/20 dark:border-zinc-700/20" />
                ...
                {/* Floating shapes */}
                <div className="absolute top-1/4 left-1/4 w-16 h-16 rotate-45 border border-primary/20 animate-pulse" />
                <div className="absolute bottom-1/3 right-1/5 w-12 h-12 rotate-12 border border-primary/15 rounded-lg animate-bounce" style={{ animationDuration: '3s' }} />
                <div className="absolute top-1/3 right-1/4 w-8 h-8 rounded-full bg-primary/5 animate-pulse" style={{ animationDelay: '1s' }} />
                <div className="absolute bottom-1/4 left-1/3 w-20 h-20 rotate-[30deg] border-2 border-dashed border-zinc-300/40 dark:border-zinc-600/40 rounded-xl" />
                
                {/* Extra decorative elements for signup */}
                <div className="absolute top-1/2 right-12 w-4 h-4 rounded-full bg-primary/10 animate-ping" style={{ animationDuration: '2s' }} />
                <div className="absolute bottom-1/2 left-12 w-6 h-6 rounded-full border-2 border-primary/20 animate-spin" style={{ animationDuration: '8s' }} />
            </div>
            ...
            <Card className="w-full max-w-md shadow-2xl border-zinc-200/50 dark:border-zinc-700/50 backdrop-blur-sm bg-white/80 dark:bg-zinc-900/80 relative z-10 animate-fade-in">
                ...
                <CardHeader className="space-y-1 text-center pb-2">
                    <div className="mx-auto w-12 h-12 bg-primary/10 rounded-xl flex items-center justify-center mb-4 group hover:bg-primary/20 transition-colors">
                        <span className="text-2xl font-black text-primary group-hover:scale-110 transition-transform">N</span>
                    </div>
                    <CardTitle className="text-2xl font-bold tracking-tight">
                        Create your account
                    </CardTitle>
                    <CardDescription className="text-zinc-500 dark:text-zinc-400">
                        Start building powerful workflows in minutes
                    </CardDescription>
                </CardHeader>
